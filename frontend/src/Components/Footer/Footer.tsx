...
const Footer = () => {
  return (
    <Styled.Container>
        <Styled.socialPart>
            <Styled.socialTextWarpper>
                <Styled.socialText>Get connected with us on social networks:</Styled.socialText>   
      </Styled.socialTextWarpper>
      <Styled.iconsWarpper>
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-white">Accsesuries</a>
        </p>
        <p>
          <a href="#!" className="text-white">Care Tools</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-medium mb-4 flex justify-center md:justify-start">
  ...
  <div className="text-center p-6 bg-green-600">
    ...
    <a className="text-white font-medium" href="https://tailwind-elements.com/">Cozy Jungle</a>
  </div>
</Styled.Container>
    )
}

...
import { faqs, license, reviews } from './ProductScreen.utiles'
...
// import { Tab } from '@headlessui/react'
// import Spinner from '../../Components/Spinner/Spinner'
// import Styled from '../ProductScreen/ProductScreen.style'
// import Context from '../../Context/context'
// import AppContext from '../../interface/AppContext'
// import Box from '@mui/material/Box';
// import InputLabel from '@mui/material/InputLabel';
...
// const {img,price,description,name,plantFamily} = product as Product
// const [qauntity,setQantity] = useState(1)
// const [open,setOpen] = useState(false)
// const {cart,changeCart} = useContext(Context) as AppContext;
...
//              <Styled.Product>
//                  <Styled.ProductImage>
//                      <Styled.mainImageWarpper>
//                          <Styled.mainImage src={img} alt=""/>
//                 </Styled.mainImageWarpper>
//                 <Styled.SecondaryImagesWarpper>
...
//         <Styled.HeadingWarpper>
//           <Styled.HeadingGap>
//             <Styled.Heading>{name} </Styled.Heading>
//             <Styled.SubHeading> {plantFamily} </Styled.SubHeading>
//             {/* <h2 id="information-heading" className="sr-only">
//               Product information
//             </h2> */}
...
//           <Styled.btnWarpper>
//             <Styled.btn onClick={addToCart} type="button"> Add Plant to cart </Styled.btn>
